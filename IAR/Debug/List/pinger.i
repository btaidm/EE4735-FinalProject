...
void SetupPinger(pinger_t* pingerPtr)
{
    ...
    *(pingerPtr->trigger.dir) |= 0x01 << pingerPtr->trigger.pin; 
    *(pingerPtr->trigger.out) &= ~( 0x01 << pingerPtr->trigger.pin); 

    
    *(pingerPtr->echo.dir) &= ~( 0x01 << pingerPtr->echo.pin); 
    *(pingerPtr->echo.sel) |= ( 0x01 << pingerPtr->echo.pin);  
}

void StartPinger(pinger_t* pingerPtr)
{
    P1OUT ^= ( 0x01 << pingerPtr->ledpin); 
    *(pingerPtr->trigger.out) |= ( 0x01 << pingerPtr->trigger.pin); 
